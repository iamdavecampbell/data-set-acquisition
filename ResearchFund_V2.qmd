...
data = pd.read_csv("https://files.ontario.ca/opendata/orfre_apr_20_18_0.csv", skiprows=1, encoding='unicode_escape')
...
ins = data[["year", "Lead Research Institution"]]

ins = ins.groupby(["Lead Research Institution", "year"])["Lead Research Institution"].count()


#ins = ins.sort_values("Lead Research Institution")

#ins = data.groupby(["year", "Lead Research Institution"],
#                             as_index=False)['Lead Research Institution'].count()
