...
quarterlydata <- read.csv(unz(temp, "16100100.csv"), stringsAsFactors = FALSE)
...
(file_list <- as.character(unzip(temp, list = TRUE)$Name))
monthlydata <- read.csv(unz(temp, "16100099.csv"), stringsAsFactors = FALSE)
unlink(temp)
