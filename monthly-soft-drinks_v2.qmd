...
```{python organize monthly and annual data}
...
```{python display quarterly data}

AllQuarters.head()

```

```{python display annual data}

annual.head()

```

```{python display monthly data}
