...
```{python employmentprovincesplots}

sb.pairplot(pivoted, vars = pivoted.columns[4:14])
plt.show()

plt.clf()
sb.lineplot(data = provinces,
            x = "REF_DATE",
            y = "VALUE",
            hue = "GEO")

plt.ylabel("Unemployment rate")
plt.title("Unemployment Rates by Province")
...
```{python employmentprovincesplots2}


plt.clf()
sb.relplot(data = provinces,
            x = "REF_DATE",
            y = "VALUE",
            hue = "GEO",
            col = "GEO",
