...
sb.lineplot(
  ...
  y="AnnualValue", 
  ax = ax)
ax.set_title("Annual soft drink production")
plt.show()
...
sb.lineplot(
  ...
  marker="o",
  ax = ax)
ax.set_title("Quarterly soft drink production")
plt.show()
...
sb.lineplot(
  ...
  y="Produced",
  ax = ax)
ax.set_title("Monthly soft drink production")
plt.show()
...
proportions.plot(
  ...
  stacked = True,
  ax = ax)
ax.set_title("Percent Stacked Barchart of Quaterly Soft Drink Production")
ax.set_xlabel("Year")
