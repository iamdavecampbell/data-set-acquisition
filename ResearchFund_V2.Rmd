...
data <- read.csv("https://files.ontario.ca/opendata/orfre_apr_20_18_0.csv", stringsAsFactors = FALSE, header = TRUE,skip=1)
...
* Research programs are separated into 5 areas: Advanced health technologies, Bio-economy and clean technologies, Digital media information and communications technologies, Pharmaceutical research and manufacturing, and other unspecified groups.


```{r percent, warning = FALSE}
