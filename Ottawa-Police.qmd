...
crime = pd.read_csv("https://stg-arcgisazurecdataprod7.az.arcgis.com/exportfiles-858-692/CrimeMap_YE_-5915901148112462236.csv?sv=2018-03-28&sr=b&sig=QYKXqTWhRh1TrGHU9xlwyHwMIieWsD87Ae7RdKg1pTo%3D&se=2024-07-18T15%3A47%3A26Z&sp=r")
...
url = "https://stg-arcgisazurecdataprod7.az.arcgis.com/exportfiles-858-723/Shootings_Open_Data_3086844035331583488.csv?sv=2018-03-28&sr=b&sig=5yvh1Wqzz9hcUSC6KSUhoKWrFbSlFOrexSeFhxcUsNo%3D&se=2024-07-17T15%3A32%3A30Z&sp=r"

temp = tf.TemporaryFile()

r = requests.get(url)

test = pd.read_csv(r.content)
...
url = "https://stg-arcgisazurecdataprod7.az.arcgis.com/exportfiles-858-723/Shootings_Open_Data_3086844035331583488.csv?sv=2018-03-28&sr=b&sig=T%2FUcCA7fhMR46RZK9zLsnzCFAOqTXeFfUpFOiY8CbkI%3D&se=2024-07-18T18%3A59%3A53Z&sp=r"
