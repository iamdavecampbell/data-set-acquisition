...
#canada.head()
canada2 = tongue[tongue["Mother tongue"] != "Total, mother tongue"]
#canada2.head()


#sb.lineplot(data = (tongue[(tongue["location"] == "Canada") and (tongue["Mother tongue"] != "Total, mother tongue")]), 
#x = "year", y = "Percentage", hue = "Mother tongue").set_title("Percentage of speakers of mother tongues in Canada")
