...
not_eng_plot_1 = sb.lineplot(data = (tongue[(tongue["location"] != "Canada") & 
                             ...
                             y = "Percentage",
                              hue = "location")
not_eng_plot_1.set_title("Percentage of French mother tongues in different provinces")
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0)
plt.show()

```

``` {python other language 2}
...
not_eng_plot_2 = sb.lineplot(data = (tongue[(tongue["location"] != "Canada") & 
                             ...
                             y = "Percentage",
                             hue = "location")
not_eng_plot_2.set_title("Percentage of non-official language mother tongues in different provinces")
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0)
plt.show()
