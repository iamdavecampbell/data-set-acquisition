...
subtitle: ''
summary: 'Using Python libraries to acquire socioeconomic data from Statistics Canada Mapper.'
...
Statistics Canada hosts a large set of socio-economic [datasets](https://www150.statcan.gc.ca/n1//en/type/data?MM=1#tables).  When searching through these, take note of the _table_ identifier.  The **stats-can** and **cansim** packages provides an API for downloading these tables.  See also the 
...
Notice how we produce a year and month columns by accessing properties of **pandas datetime** objects. 
...
## Python
A "decade" column is produced using floor division. The yearly data lines are colour grouped by decade so 2020-2021 are inherrently already highlighted.
